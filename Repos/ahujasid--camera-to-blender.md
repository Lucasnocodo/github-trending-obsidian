---
repo: ahujasid/camera-to-blender
...
**778** stars · **156** stars/天 · 建立 5 天前 · JavaScript · MIT

```dataviewjs
const me = dv.page("Repos/ahujasid--camera-to-blender");
...
| 建立日期 | 2026-09-03 |
| Repo 大小 | 31 KB |
| OpenSSF Scorecard | [查看](https://scorecard.dev/viewer/?uri=github.com/ahujasid/camera-to-blender) |
...
> | 貢獻者 | Commits |
> | --- | --- |
> | [@ahujasid](https://github.com/ahujasid) | 2 |
> | [@comoc](https://github.com/comoc) | 1 |

## 開發動態

> [!abstract] 最近 10 次 commit（2026-09-03 ~ 2026-09-05）
> **活躍天數** 2 天 · **最新 commit** Merge pull request #2 from comoc/fix/tripo-model-version
...
[GitHub](https://github.com/ahujasid/camera-to-blender)
...
> FROM "Repos"
> WHERE category = "Other" AND file.name != "ahujasid--camera-to-blender"
> SORT stars DESC
> LIMIT 8
> ```
...
> FROM "Repos"
> WHERE language = "JavaScript" AND file.name != "ahujasid--camera-to-blender" AND status != "archived"
...
> FROM "Repos"
> WHERE week = "2026-W37" AND file.name != "ahujasid--camera-to-blender"
> SORT stars DESC
> ```
...
>     .where(p => p.file.name !== "ahujasid--camera-to-blender" && p.category === me.category && (ringOrder[p.ring] || 0) > myRing)
...
> FROM "Repos"
> WHERE owner = "ahujasid" AND file.name != "ahujasid--camera-to-blender"
> SORT stars DESC
> ```
...
- [[2026-09-09|2026-09-09]] — 首次收錄，778 stars
