...
star_history: "2026-09-13:708,2026-09-14:736,2026-09-15:749"
tags:
  - github
  - "category/other"
  - "lang/python"
...
**708** stars · **177** stars/天 · 建立 4 天前 · Python · MIT

```dataviewjs
const me = dv.page("Repos/SpaceDudem--text-humanizer");
...
| 建立日期 | 2026-09-08 |
| Repo 大小 | 62 KB |
| OpenSSF Scorecard | [查看](https://scorecard.dev/viewer/?uri=github.com/SpaceDudem/text-humanizer) |
| Topics | `ai-humanizer` `gpt-zero` `text-humanizer` |

> [!info]- 主要依賴
> `requirements.txt` 中的核心套件：
> `httpx` `toml` `click` `rich` `python-dotenv` `deep-translator` `tornado`

> [!info]- 主要貢獻者
> | 貢獻者 | Commits |
> | --- | --- |
> | [@SpaceDudem](https://github.com/SpaceDudem) | 9 |

## 開發動態

> [!abstract] 最近 10 次 commit（2026-09-08 ~ 2026-09-08）
> **活躍天數** 1 天 · **最新 commit** dockerfile update
...
[GitHub](https://github.com/SpaceDudem/text-humanizer)
...
> FROM "Repos"
> WHERE category = "Other" AND file.name != "SpaceDudem--text-humanizer"
> SORT stars DESC
> LIMIT 8
> ```
...
> FROM "Repos"
> WHERE language = "Python" AND file.name != "SpaceDudem--text-humanizer" AND status != "archived"
...
> FROM "Repos"
> WHERE week = "2026-W38" AND file.name != "SpaceDudem--text-humanizer"
> SORT stars DESC
> ```
...
>     .where(p => p.file.name !== "SpaceDudem--text-humanizer" && p.category === me.category && (ringOrder[p.ring] || 0) > myRing)
...
> FROM "Repos"
> WHERE owner = "SpaceDudem" AND file.name != "SpaceDudem--text-humanizer"
> SORT stars DESC
> ```
...
- [[2026-09-15|2026-09-15]] — 再次上榜，749 stars
- [[2026-09-14|2026-09-14]] — 再次上榜，736 stars
- [[2026-09-13|2026-09-13]] — 首次收錄，708 stars
