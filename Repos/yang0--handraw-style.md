...
**1.1k** stars · **220** stars/天 · 建立 5 天前 · HTML · 未標註授權

```dataviewjs
const me = dv.page("Repos/yang0--handraw-style");
...
| 建立日期 | 2026-09-05 |
| Repo 大小 | 97.3 MB |
| OpenSSF Scorecard | [查看](https://scorecard.dev/viewer/?uri=github.com/yang0/handraw-style) |
...
> | 貢獻者 | Commits |
> | --- | --- |
> | [@yang0](https://github.com/yang0) | 4 |

## 開發動態

> [!abstract] 最近 10 次 commit（2026-09-05 ~ 2026-09-09）
> **活躍天數** 2 天 · **最新 commit** feat: organize style assets and gallery workflow
...
> | --- | --- | --- | --- |
> | [#1](https://github.com/yang0/handraw-style/issues/1) | [FR] 建议增加南方公园的纸片人风格和啪塔砰的剪影风格 | 0 | 0 |
...
> 
> 这里整理了 **001–261 种手绘风格**。先选一个编号，再告诉 Skill 你想表现的主题，就能得到带有风格名称的中文和英文提示词，直接交给支持生图的 AI 使用。
> 
> ## 它适合谁
> 
> - 不知道该怎么描述画风的创作者
...
> FROM "Repos"
> WHERE category = "Other" AND file.name != "yang0--handraw-style"
> SORT stars DESC
> LIMIT 8
> ```
...
> FROM "Repos"
> WHERE language = "HTML" AND file.name != "yang0--handraw-style" AND status != "archived"
...
> FROM "Repos"
> WHERE week = "2026-W37" AND file.name != "yang0--handraw-style"
> SORT stars DESC
> ```
...
>     .where(p => p.file.name !== "yang0--handraw-style" && p.category === me.category && (ringOrder[p.ring] || 0) > myRing)
...
> FROM "Repos"
> WHERE owner = "yang0" AND file.name != "yang0--handraw-style"
> SORT stars DESC
> ```
