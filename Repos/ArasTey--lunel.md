...
**692** stars · **115** stars/天 · 建立 6 天前 · Python · NOASSERTION

```dataviewjs
const me = dv.page("Repos/ArasTey--lunel");
...
| 建立日期 | 2026-09-09 |
| Repo 大小 | 279 KB |
| OpenSSF Scorecard | [查看](https://scorecard.dev/viewer/?uri=github.com/ArasTey/lunel) |

> [!info]- 主要依賴
> `requirements.txt` 中的核心套件：
> `fastapi` `uvicorn` `asyncpg` `httpx` `websockets` `cryptography` `psutil` `aiosqlite` `qrcode`
...
> | 貢獻者 | Commits |
> | --- | --- |
> | [@ArasTey](https://github.com/ArasTey) | 2 |

## 開發動態

> [!abstract] 最近 10 次 commit（2026-09-09 ~ 2026-09-13）
> **活躍天數** 4 天 · **最新 commit** Update requirements.txt
...
> | --- | --- | --- | --- |
> | [#3](https://github.com/ArasTey/lunel/issues/3) | ایده دارم | 0 | 0 |
> | [#2](https://github.com/ArasTey/lunel/issues/2) | Hello from Lucity ;) | 0 | 0 |
...
> FROM "Repos"
> WHERE category = "Other" AND file.name != "ArasTey--lunel"
> SORT stars DESC
> LIMIT 8
> ```
...
> FROM "Repos"
> WHERE language = "Python" AND file.name != "ArasTey--lunel" AND status != "archived"
...
> FROM "Repos"
> WHERE week = "2026-W38" AND file.name != "ArasTey--lunel"
> SORT stars DESC
> ```
...
>     .where(p => p.file.name !== "ArasTey--lunel" && p.category === me.category && (ringOrder[p.ring] || 0) > myRing)
...
> FROM "Repos"
> WHERE owner = "ArasTey" AND file.name != "ArasTey--lunel"
> SORT stars DESC
> ```
...
- [[2026-09-16|2026-09-16]] — 首次收錄，692 stars
